...
\usepackage{fancyhdr}
%%%%%
% Make 0.75'' margins on all sides
...
% Header Info
\fancyhead[C]{}
\fancyhead[L]{Saving Connor}
\fancyhead[R]{Page \thepage}
\fancyfoot[L]{Created \today}
\fancyfoot[C]{Fanfiction.net}
\fancyfoot[R]{Written by Lightning On The Wave}
%opening
\title{Saving Connor}
...
\section{Brother's Keeper}\label{chapter-1-chapter-1}
...
\section{Meetings, Cordial and Otherwise}\label{chapter-2-meetings-cordial-and-otherwise}
...
\section{Arguments With the Sorting Hat}\label{chapter-3-arguments-with-the-sorting-hat}
...
\section{Detention With the Potions Master}\label{chapter-4-detention-with-the-potions-master}
...
\section{The Lion and the Serpent}\label{chapter-5-the-lion-and-the-serpent}
...
\section{Suspicious Eyes}\label{chapter-6-suspicious-eyes}
...
\section{Humility}\label{chapter-7-humility}
...
\section{Dares and Dives}\label{chapter-8-dares-and-dives}
...
\section{Sacrificial Unicorn}\label{chapter-9-sacrificial-unicorn}
...
\section{Connor's Big Day}\label{chapter-10-connors-big-day}
...
\section{Power United With Love}\label{chapter-11-power-united-with-love}
...
\section{Interlude: Correspondence}\label{chapter-12-interlude-correspondence}
...
\section{Three Uncomfortable Conversations}\label{chapter-13-three-uncomfortable-conversations}
...
\section{Discoveries}\label{chapter-14-discoveries}
...
\section{Draco In Danger}\label{chapter-15-draco-in-danger}
...
\section{A Very Malfoyish Christmas}\label{chapter-16-a-very-malfoyish-christmas}
...
\section{The Dance}\label{chapter-17-the-dance}
...
\section{Interlude: Concerned Relatives}\label{chapter-18-interlude-concerned-relatives}
...
\section{Between Brothers}\label{chapter-19-between-brothers}
...
\section{Putting the Pieces Together}\label{chapter-20-putting-the-pieces-together}
...
\section{The Boy Who Lived}\label{chapter-21-the-boy-who-lived}
...
\section{Truth}\label{chapter-22-truth}

...
% In case of  >100 chapters
\usepackage[tocindentauto]{tocstyle}
\usetocstyle{standard}
%%% Opening
\begin{document}
\title{No Mouth But Some Serpent's}
...
\chapter*{Word from the Author}

\textbf{Disclaimer:} The recognizable characters, settings, and events in this story do not belong to me, but to J. K. Rowling. I am writing this story for fun and not profit.

\textbf{Notes:} Hello, and welcome to the second installment of the Massive Freaking AU I find myself in the process of writing.

This is the sequel to \emph{Saving Connor}, and will probably make no sense at all if you haven't read that story. This is the version of Harry's second year at Hogwarts, in a world where his parents are alive, Peter was sent to Azkaban, and his brother Connor is believed to be the Boy-Who-Lived, thanks to a heart-shaped scar he bears. Harry is Connor's guide, guardian, and protector, and proud to be so, despite being Sorted into Slytherin and picked at to be more Slytherin by both Draco and Snape.

That's enough, I think. You already know what to expect if you've read \emph{Saving Connor}, and if you haven't, no summary's going to be enough.

\textbf{Warnings:} Language, violence, eventual HP/DM slash in fourth year and beyond. Also, beyond this point, \textbf{multiple character deaths}, including ones that do not happen in canon. \textbf{No one is safe.} If you find it very hard to read a story like that, bail now.
...
\chapter{The Scabbed Summer}\label{chapter-1-the-scabbed-summer}
...
\chapter{Old Family Rivalries}\label{chapter-2-old-family-rivalries}
...
\chapter{A Touch of Sirius}\label{chapter-3-a-touch-of-sirius}
...
\chapter{Snape Baiting}\label{chapter-4-snape-baiting}
...
\chapter{Like A Gryffindor}\label{chapter-5-like-a-gryffindor}
...
\chapter{Moons and Wouldbe Stars}\label{chapter-6-moons-and-wouldbe-stars}
...
\chapter{Lessons In Courage}\label{chapter-7-lessons-in-courage}
...
\chapter{Interlude: Lily's Letter}\label{chapter-8-interlude-lilys-letter}
...
\chapter{What A Tangled Web We Weave}\label{chapter-9-what-a-tangled-web-we-weave}
...
\chapter{That Sharp Spark of Betrayal}\label{chapter-10-that-sharp-spark-of-betrayal}
...
\chapter{Fugitivus Animus}\label{chapter-11-fugitivus-animus}
...
\chapter{Threats and Throws}\label{chapter-12-threats-and-throws}
...
\chapter{Paralysis}\label{chapter-13-paralysis}
...
\chapter{A Grim Hope}\label{chapter-14-a-grim-hope}
...
\chapter{Paying the Piper}\label{chapter-15-paying-the-piper}
...
\chapter{No One Ever Notices a Hufflepuff}\label{chapter-16-no-one-ever-notices-a-hufflepuff}
...
\chapter{Battle Plans}\label{chapter-17-battle-plans}
...
\chapter{Comes the Test}\label{chapter-18-comes-the-test}
...
\chapter{Recovery}\label{chapter-19-recovery}
...
\chapter{Coterie}\label{chapter-20-coterie}
...
\chapter{Lockhart's Very Special Idea}\label{chapter-21-lockharts-very-special-idea}
...
\chapter{A Renewal of Bonds}\label{chapter-22-a-renewal-of-bonds}
...
\chapter{A Gryffindor Among the Slytherins}\label{chapter-23-a-gryffindor-among-the-slytherins}
...
\chapter{Two Snakes in the Lions' Den}\label{chapter-24-two-snakes-in-the-lions-den}
...
\chapter{The Past Comes Home to Roost}\label{chapter-25-the-past-comes-home-to-roost}
...
\chapter{Over Easter Holidays}\label{chapter-26-over-easter-holidays}
...
\chapter{Father and Son}\label{chapter-27-father-and-son}
...
\chapter{Home Is The Hunter}\label{chapter-28-home-is-the-hunter}
...
\chapter{Walk These Roads}\label{chapter-29-walk-these-roads}
...
\chapter{Fang to Fang}\label{chapter-30-fang-to-fang}
...
\chapter{The Heart of the Storm}\label{chapter-31-the-heart-of-the-storm}
...
\chapter{The Boy Who Survived}\label{chapter-32-the-boy-who-survived}
...
\chapter{Interlude: Two Letters}\label{chapter-33-interlude-two-letters}
\noindent \emph{June 12th, 1993}

\noindent To: Auror Department
...
\noindent Please let me know at your earliest convenience whether I may be obliged
in this matter.
